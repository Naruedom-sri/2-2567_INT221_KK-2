describe(`TC-FE-PBI2-VIEW-SALE-ITEM-DETAIL-1\n 
  ...
  it(`Open the 11th sale item at ${resource}/16. The sale item should be "Samsung,Galaxy S23 Ultra/-/512GB/39,600".`, () => {
    ...
    cy.get("@row").contains(
      ".itbms-description",
      "Samsung Galaxy S23 Ultra 512GB สีดำปีศาจ สภาพนางฟ้า 99% ไร้รอย แถมเคสแท้ แบตอึดสุดๆ รองรับปากกา S-Pen อุปกรณ์ครบกล่อง ประกันศูนย์เหลือ 6 เดือน ส่งฟรี"
    );
  ...
  it(`Open the 22th sale item at ${resource}/32. The sale item should be "Xiaomi,13T Pro/12/-GB/23,100".`, () => {
    ...
    cy.get("@row").contains(
      ".itbms-description",
      "Xiaomi 13T Pro 12/512GB สี Meadow Green ชิป Dimensity 9200+ เร็วแรง กล้อง Leica ถ่ายรูปสวยขั้นเทพ มีที่ชาร์จ 120W ครบกล่อง จัดส่งฟรีทั่วประเทศ"
    );
