DROP database IF EXISTS ITBMS;
CREATE DATABASE ITBMS;
USE ITBMS;
CREATE TABLE brands (
    brandId INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL UNIQUE,
...
('SELLER', 'Somsuk', 'itbkk.somsuk@ad.sit.kmutt.ac.th', 'itProj24*SOM','ACTIVE', 'Somsuk Fundee'),
('SELLER', 'Somsak', 'itbkk.somsak@ad.sit.kmutt.ac.th', 'itProj24*SOM','ACTIVE', 'Soksak Saksit');

INSERT INTO sellers (userId, mobileNumber, bankAccountNumber, bankName, nationalIdNumber,nationalIdPhotoFront , nationalIdPhotoBack) VALUES
...
-- Orders ของ buyerId = 2 (Somchai) ซื้อจาก sellerId = 3,4
INSERT INTO orders (buyerId, sellerId, orderDate, paymentDate, shippingAddress, orderNote, orderStatus) VALUES
(2, 3, '2023-09-01 14:20:00', '2023-09-01 14:25:00', '123 ถนนสุขุมวิท กรุงเทพฯ', 'ส่งเร็วๆนะครับ', 'COMPLETED'),
(2, 4, '2023-09-05 11:10:00', '2023-09-05 11:12:00', '88 ซอยเจริญกรุง บางรัก กรุงเทพฯ', 'ใส่กล่องกันกระแทกด้วย', 'COMPLETED'),
-- Orders ของ buyerId = 3 (Somkiat) ซื้อจาก sellerId = 3
(3, 4, '2023-09-07 18:45:00', '2023-09-07 18:46:00', '456 หมู่บ้านสุขใจ นนทบุรี', 'เก็บเงินปลายทาง', 'CANCELED'),
(3, 5, '2023-09-07 18:45:00', '2023-09-07 18:46:00', '456 หมู่บ้านสุขใจ นนทบุรี', 'เก็บเงินปลายทาง', 'COMPLETED'),
-- Orders ของ buyerId = 2 ซื้อจาก sellerId = 4
(2, 4, '2023-09-10 09:15:00', '2023-09-10 09:17:00', '99/9 ถนนลาดพร้าว กรุงเทพฯ', 'ห่อเป็นของขวัญด้วย', 'COMPLETED'),
-- Orders ของ buyerId = 1 (yorch) ซื้อจาก sellerId = 4,5
(1, 4, '2023-09-12 10:30:00', '2023-09-12 10:32:00', '222 ถนนพระราม 9 กรุงเทพฯ', 'ช่วยเช็คเครื่องให้ก่อนส่งครับ', 'COMPLETED'),
(1, 5, '2023-09-14 15:00:00', '2023-09-14 15:05:00', '55/5 หมู่บ้านการ์เด้น รังสิต ปทุมธานี', 'ส่ง Kerry ให้หน่อยครับ', 'COMPLETED'),
(1, 4, '2023-09-15 20:10:00', '2023-09-15 20:12:00', '333/33 ซอยสุขุมวิท 101 กรุงเทพฯ', 'ส่งพร้อมฟิล์มกันรอยด้วย', 'CANCELED');

-- Order 1 (Somchai ซื้อจาก seller 3)
INSERT INTO order_items (orderId, saleItemId, quantity, description, price) VALUES
(1, 1, 1, 'iPhone 14 Pro Max', 42900.00),
(1, 7, 2, 'iPhone SE 2022', 14190.00);

-- Order 2 (Somchai ซื้อจาก seller 4)
INSERT INTO order_items (orderId, saleItemId, quantity, description, price) VALUES
(2, 2, 1, 'iPhone 14', 29700.00),
(2, 10, 1, 'iPhone 12 mini', 16500.00);

-- Order 3 (Somkiat ซื้อจาก seller 3) (CANCELED)
INSERT INTO order_items (orderId, saleItemId, quantity, description, price) VALUES
(3, 16, 1, 'Galaxy S23 Ultra', 39600.00);

-- Order 4 (Somchai ซื้อจาก seller 4)
INSERT INTO order_items (orderId, saleItemId, quantity, description, price) VALUES
(4, 19, 1, 'Galaxy Z Flip4', 33000.00),
(4, 25, 1, 'Galaxy S21 FE', 19800.00);

-- Order 5 (yorch ซื้อจาก seller 4)
INSERT INTO order_items (orderId, saleItemId, quantity, description, price) VALUES
(5, 2, 1, 'iPhone 14', 29700.00),
(5, 6, 1, 'iPhone 12', 19800.00);

-- Order 6 (yorch ซื้อจาก seller 5)
INSERT INTO order_items (orderId, saleItemId, quantity, description, price) VALUES
(6, 17, 1, 'Galaxy S23+', 33000.00),
(6, 25, 2, 'Galaxy S21 FE', 19800.00);

-- Order 7 (yorch ซื้อจาก seller 4, แต่ CANCELED)
INSERT INTO order_items (orderId, saleItemId, quantity, description, price) VALUES
(7, 40, 1, 'Redmi Note 11', 8250.00);
